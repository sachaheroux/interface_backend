...
def lpt_algorithm(task_tuples: List[tuple], cycle_time: float, unite: str = "minutes") -> Dict:
    """
...
def generate_station_chart(stations: List[List], utilization_rates: List[float], tasks: Dict, unite: str) -> str:
    ...
    # Graphique 2: Temps de traitement par station avec indication LPT
    station_times = []
    station_details = []
    ...
    bars2 = ax2.bar(station_numbers, station_times, color='lightcoral', alpha=0.7)
